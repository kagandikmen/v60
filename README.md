...
Across the 17 ICCAD04 IBM benchmarks (the 18-design suite minus ibm05, which contains no macros), v60 reaches an average proxy cost of 0.8946 in full mode and 0.9435 in fast mode, with no macro overlaps on any design.
